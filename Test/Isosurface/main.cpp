...
int main( int argc, char** argv )
{
    ...
    kvs::PolygonObject* yng_object = new YYZVis::Isosurface( &yng_volume, isovalue, n, d, cmap );
    kvs::PolygonObject* zng_object = new YYZVis::Isosurface( &zng_volume, isovalue, n, d, cmap );

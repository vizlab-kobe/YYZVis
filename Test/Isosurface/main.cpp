...
int main( int argc, char** argv )
{
    ...
    kvs::PolygonObject* yin_object = new YYZVis::Isosurface( &yin_volume, isovalue, n, d, cmap );
    kvs::PolygonObject* yang_object = new YYZVis::Isosurface( &yang_volume, isovalue, n, d, cmap );
    kvs::PolygonObject* zhong_object = new YYZVis::Isosurface( &zhong_volume, isovalue, n, d, cmap );

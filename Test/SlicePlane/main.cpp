...
int main( int argc, char** argv )
{
    ...
    kvs::PolygonObject* yang_object = new YYZVis::SlicePlane( &yang_volume, point, normal, cmap );
    kvs::PolygonObject* zhong_object = new YYZVis::SlicePlane( &zhong_volume, point, normal, cmap );

...
/*===========================================================================*/
/**
 *  @brief  Base class for Yin-Yang volume object.
 */
/*===========================================================================*/
class YinYangVolumeObjectBase : public kvs::VolumeObjectBase
{
    kvsModule( YYZVis::YinYangVolumeObjectBase, Object );
    kvsModuleBaseClass( kvs::VolumeObjectBase );

public:
    static kvs::StructuredVolumeObject* ToStructuredVolumeObject( const YinYangVolumeObjectBase* object );
    static kvs::UnstructuredVolumeObject* ToUnstructuredVolumeObject( const YinYangVolumeObjectBase* object );
...
public:
    YinYangVolumeObjectBase();
    YinYangVolumeObjectBase( const YinYangVolumeObjectBase& object ) { this->shallowCopy( object ); }

    void shallowCopy( const YinYangVolumeObjectBase& object );
    void deepCopy( const YinYangVolumeObjectBase& object );

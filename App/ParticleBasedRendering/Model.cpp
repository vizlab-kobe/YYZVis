...
kvs::PolygonObject* Model::newYinFaces() const
{
    ...
    return this->newYinFaces( volume.get() );
}

kvs::PolygonObject* Model::newYangFaces() const
{
    ::VolumePointer volume( YangVolume::ToUnstructuredVolumeObject( &m_yang_volume ) );
    return this->newYangFaces( volume.get() );
}

kvs::PolygonObject* Model::newZhongFaces() const
{
    ::VolumePointer volume( ZhongVolume::ToUnstructuredVolumeObject( &m_zhong_volume ) );
    return this->newZhongFaces( volume.get() );
}

kvs::PolygonObject* Model::newYinFaces( const kvs::UnstructuredVolumeObject* volume ) const
{
    return new kvs::ExternalFaces( volume );
}

kvs::PolygonObject* Model::newYangFaces( const kvs::UnstructuredVolumeObject* volume ) const
{
    return new kvs::ExternalFaces( volume );
}

kvs::PolygonObject* Model::newZhongFaces( const kvs::UnstructuredVolumeObject* volume ) const
{
    return new kvs::ExternalFaces( volume );
}

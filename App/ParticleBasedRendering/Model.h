...
public:
    ...
    kvs::PolygonObject* newYinFaces( const kvs::UnstructuredVolumeObject* volume ) const;
    kvs::PolygonObject* newYangFaces( const kvs::UnstructuredVolumeObject* volume ) const;
    kvs::PolygonObject* newZhongFaces( const kvs::UnstructuredVolumeObject* volume ) const;
